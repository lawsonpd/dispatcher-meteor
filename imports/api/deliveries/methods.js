...
// var twilioSid = Meteor.settings.twilioSid;
// var twilioAuthToken = Meteor.settings.twilioAuthToken;
...
Meteor.methods({
  ...
  'confirm-availability'({ deliveryId, phoneNumber, address }) {
    // console.log(deliveryId, phoneNumber, address);
